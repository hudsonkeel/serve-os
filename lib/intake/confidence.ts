...
const DEDUCTIONS: Partial<Record<IntakeReasonCode, number>> = {
  ...
  RESIDENT_LINK_UNRESOLVED: -15,
  PROSPECTIVE_CLIENT_NAME_NOT_COLLECTED: -25,
  INCOMPLETE_PROSPECTIVE_CLIENT: -15,
  PRIMARY_CONTACT_IDENTITY_INCOMPLETE: -20,
  SERVICE_LOCATION_INCOMPLETE: -25,
  INCOMPLETE_SERVICE_LOCATION: -10,
  INCOMPLETE_CARE_CONTEXT: -5,
  CONFLICTING_LOCATION_SIGNALS: -30,
  CONTACT_METHOD_MISSING: -50,
  MISSING_CONTACT_NAME: -50,
  MISSING_CONTACT_METHOD: -50,
