...
--
-- RENUMBERED (2026-08-16, branch reconciliation): originally authored as 20260902060000 on a
-- branch built before origin/main's Client Readiness / Audit Readiness / Multi-Community work
-- merged. That work independently claimed 20260902060000 for an unrelated migration
-- (add_audit_session_corrections.sql), and separately added community_id to
-- intake_assessment_sessions (20260902220000) — verified not to touch the status constraint
-- this migration owns. Moved to 20260902370000, immediately after main's latest migration at
-- reconciliation time (20260902360000). No other origin/main migration in the 20260902xxxxxx
-- series touches intake_assessment_sessions' status or its check constraints.
